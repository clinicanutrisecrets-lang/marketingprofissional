...
ev += [chapeu(4.9, 20.0, "O QUE VOCÊ RECEBE · 1 DE 5"),
       ...
       legenda(15.7, 19.9, "tudo isso entra\\Nno mesmo prato", 86)]
...
ev += [chapeu(26.2, 38.5, "O QUE VOCÊ RECEBE · 3 DE 5"),
       titulo(26.3, 38.5, "O SEU TESTE GENÉTICO", fs=74),
...
# 4 de 5
ev += [chapeu(38.7, 46.5, "O QUE VOCÊ RECEBE · 4 DE 5"),
       titulo(38.8, 46.5, "O MANUAL DO SEU CORPO", fs=70),
