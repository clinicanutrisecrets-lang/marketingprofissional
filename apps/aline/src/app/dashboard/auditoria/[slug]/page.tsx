...
export default async function AuditoriaPerfilPage({ params }: PageProps) {
  ...
  const { data: auditoriaAtual } = await aline
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-2 flex items-center gap-3">
          <h1 className="text-2xl font-bold text-zinc-900">
            Auditoria — @{perfilRow.instagram_handle}
          </h1>
        ...
        <p className="mt-1 text-sm text-zinc-600">
          20 ideias de conteúdo baseadas em gaps dos últimos posts.
        </p>

        <AuditoriaView
          perfilSlug={perfilRow.slug}
          auditoriaInicial={auditoriaAtual as Record<string, unknown> | null}
        />
      </div>
    </main>
  );
